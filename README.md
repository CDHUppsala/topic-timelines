...
An example of how to run the code (and what is needed for configuring the Topics2Themes tool) is given in ![example-topics2themes-configuration/topic_model_configuration.py][example-topics2themes-configuration/topic_model_configuration.py]. 
